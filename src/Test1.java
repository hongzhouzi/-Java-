...
public class Test1 {
	public static void main(String[] args) {
		...
		for(i=1;t_sum<=8*60*60;i++){//小于8个小时进行循环，i为循环次数
			...
			{
				/*//填第1个CNC时，下料时间+填充时间+清洗时间
				t_sum1+=t_ud_j+t_CNC_clear;
				
				//填第5个CNC时，RGV移动时间+填充时间
				t_sum1+=t2+t_ud_j+t_CNC_clear;
				
				//填充第6个CNC时，RGV移动时间+填充时间
				t_sum1+=t_ud_o+t_CNC_clear;
				...
				//填充第2个CNC时，RGV移动时间+填充时间
				t_sum1+=t1+t_ud_o+t_CNC_clear;*/
				
				
				
				/*//填第1个CNC时，填充时间
				CNC1_t=t_ud_j+t_CNC_clear+t_sum;
				t_sum1+=t_ud_j+t_CNC_clear;
				
				//填第3个CNC时，RGV移动时间+填充时间
				CNC3_t+=t1+t_ud_j+t_CNC_clear;
				t_sum1+=t1+t_ud_j+t_CNC_clear;
				
				//填充第4个CNC时，RGV移动时间+填充时间
				CNC4_t+=t_ud_o+t_CNC_clear;
				t_sum1+=t_ud_o+t_CNC_clear;
				
				//填充第5个CNC时，RGV移动时间+填充时间
				CNC5_t+=t1+t_ud_j+t_CNC_clear;
				t_sum1+=t1+t_ud_j+t_CNC_clear;
				
				//填充第6个CNC时，RGV移动时间+填充时间
				CNC6_t+=t_ud_o+t_CNC_clear;
				t_sum1+=t_ud_o+t_CNC_clear;
				
				//填充第7个CNC时，RGV移动时间+填充时间
				CNC7_t+=t1+t_ud_j+t_CNC_clear;
				t_sum1+=t1+t_ud_j+t_CNC_clear;
				
				//填充第8个CNC时，RGV移动时间+填充时间
				CNC8_t+=t_ud_o+t_CNC_clear;
				t_sum1+=t_ud_o+t_CNC_clear;
				
				//填充第2个CNC时，RGV移动时间+填充时间
				CNC2_t+=t3+t_ud_o+t_CNC_clear;
				t_sum1+=t3+t_ud_o+t_CNC_clear;*/
				...
				t_sum1+=t_ud_j;//填充物料
				t_sum+=t_ud_j;
				System.out.println("当前是第"+i+"次循环,"+",加工CNC编号：1"+"下料开始时间："+t_sum);
				...
				t_sum1+=t_ud_j;//填充物料
				t_sum+=t_ud_j;
				System.out.println("当前是第"+i+"次循环,"+",加工CNC编号：3"+"下料开始时间："+t_sum);
				...
				t_sum1+=t_ud_o;//填充物料
				t_sum+=t_ud_o;
				System.out.println("当前是第"+i+"次循环,"+",加工CNC编号：4"+"下料开始时间："+t_sum);
				...
				t_sum1+=t_ud_j;//填充物料
				t_sum+=t_ud_j;
				System.out.println("当前是第"+i+"次循环,"+",加工CNC编号：5"+"下料开始时间："+t_sum);
				...
				t_sum1+=t_ud_o;//填充物料
				t_sum+=t_ud_o;
				System.out.println("当前是第"+i+"次循环,"+",加工CNC编号：6"+"下料开始时间："+t_sum);
				...
				t_sum1+=t_ud_j;
				t_sum+=t_ud_j;
				System.out.println("当前是第"+i+"次循环,"+",加工CNC编号：7"+"下料开始时间："+t_sum);
				...
				t_sum1+=t_ud_o;
				t_sum+=t_ud_o;
				System.out.println("当前是第"+i+"次循环,"+",加工CNC编号：8"+"下料开始时间："+t_sum);
